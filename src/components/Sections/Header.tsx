...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(() => [SectionId.About, SectionId.Resume, SectionId.Portfolio, SectionId.Testimonials], []);
...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    return (
      <header className="fixed top-0 z-50 hidden w-full bg-orange-400/50 p-4 backdrop-blur sm:block" id={headerID}>
